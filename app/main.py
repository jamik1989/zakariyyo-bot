...
def build_app() -> Application:
    ...
    order_conv = ConversationHandler(
        ...
        states={
            ...
            STEP_REVIEW: [CallbackQueryHandler(takror_takror_review_action, pattern=r"^rv:")],
        },
    ...
    takror_conv = ConversationHandler(
        ...
        states={
            ...
            CallbackQueryHandler(takror_takror_review_action, pattern=r"^tkr:"),
            CallbackQueryHandler(takror_takror_edit_action, pattern=r"^tkr_edit:"),
        ],
        ...
        TK_EDIT_VALUE: [MessageHandler(filters.TEXT & ~filters.COMMAND, takror_takror_edit_text)],
        },
