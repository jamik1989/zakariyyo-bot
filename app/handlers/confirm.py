...
# --- (siz yuborgan kodning qolgan qismi o‘zgarmagan) ---
# Faqat on_review ichida create_product chaqiruviga uom_meta qo‘shildi.
...
# (qolgan handlerlaringiz: on_time_text / on_edit_choose / on_edit_value / cancel — sizdagi kabi qoladi)
